...
def create_prompt(df, query):
    ...
    system_role = f"""You are an artificial intelligence language model named "KRU" that specializes in summarizing \
    and answering documents which are sections of 'Rules for the Classification of Steel Ships, Part 5, Chapter 6' made by Korean Regisater, and you were developed by developer RUINA.
...
with st.form('form', clear_on_submit=True):
    user_input = st.text_input('질문을 입력해 주세요.', '', key='input')
